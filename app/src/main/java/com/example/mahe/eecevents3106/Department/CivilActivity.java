...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.AUTOFL;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.CIVIL;
...
public class CivilActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView eVEntName, eVEntDesc, sHAre, dAte, civilTV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.CivilEVENT);
        eVEntDesc = findViewById(R.id.CivilDesc);
        sHAre = findViewById(R.id.CivilBtnActShare);
        dAte = findViewById(R.id.CivildateDate);
        eVEntIMG = findViewById(R.id.CivilIMG);
        inviteLog = findViewById(R.id.civilINVITELog);
        civilTV = findViewById(R.id.tvPeopAttendCivil);

        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+civil_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(CivilActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(CivilActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(CivilActivity.this).load(imageURL).into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        civilTV.setText(count1+" People are attending this event");
                        civilTV.setVisibility(View.VISIBLE);
                    }
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_CIVIL, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(CIVILFL, 0);
        ...
        {
            startActivity(new Intent(CivilActivity.this, DeptEventActivity.class));
            finish();
        }
    }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(civil_Admin).child(tag).setValue(count);
        flagCivil = 1;

        editor.putInt(CIVILFL, flagCivil);
        editor.apply();

        startActivity(new Intent(CivilActivity.this, HomeActivity.class));
        finish();
