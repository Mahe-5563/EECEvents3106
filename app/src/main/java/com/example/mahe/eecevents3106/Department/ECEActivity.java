...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.CSEFL;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.ECE;
...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagCse;
...
public class ECEActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    String date;
    String description;
    String event;

    TextView eVEntName, eVEntDesc, sHAre, dAte, eceTv;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.ECEEVENT);
        eVEntDesc = findViewById(R.id.ECEDesc);
        sHAre = findViewById(R.id.ECEBtnActShare);
        dAte = findViewById(R.id.ECEdateDate);
        eVEntIMG = findViewById(R.id.ECEIMG);
        inviteLog = findViewById(R.id.eceINVITELog);
        eceTv = findViewById(R.id.tvPeopAttendEce);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+ece_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(ECEActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(ECEActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(ECEActivity.this).load(imageURL).fit().into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        eceTv.setText(count1+" People are attending this event");
                        eceTv.setVisibility(View.VISIBLE);
                    }
                }
        ...
        Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                ...
                .setSocialMetaTagParameters(
                        new DynamicLink.SocialMetaTagParameters.Builder()
                                .setTitle("Electronics and Communication Engineering")
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_ECE, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(ECEFL, 0);
        ...
        {
            startActivity(new Intent(ECEActivity.this, DeptEventActivity.class));
            finish();
        }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(ece_Admin).child(tag).setValue(count);
        flagEce = 1;

        editor.putInt(ECEFL, flagEce);
        editor.apply();
