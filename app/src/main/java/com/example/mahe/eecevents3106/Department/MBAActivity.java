...
public class MBAActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    String date;
    String description;
    String event;

    TextView eVEntName, eVEntDesc, sHAre, dAte, mbaTV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.EVENTMBA);
        eVEntDesc = findViewById(R.id.DescMBA);
        sHAre = findViewById(R.id.MBABtnActShare);
        dAte = findViewById(R.id.dateDateMBA);
        eVEntIMG = findViewById(R.id.IMGMBA);
        inviteLog = findViewById(R.id.MBAINVITELog);
        mbaTV = findViewById(R.id.tvPeopAttendMba);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+mba_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(MBAActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(MBAActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(MBAActivity.this).load(imageURL).fit().into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        mbaTV.setText(count1+" People are attending this event");
                        mbaTV.setVisibility(View.VISIBLE);
                    }
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_MBA, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(MBAFL, 0);
        ...
        {
            startActivity(new Intent(MBAActivity.this, DeptEventActivity.class));
            finish();
        }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(mba_Admin).child(tag).setValue(count);
        flagmba = 1;

        editor.putInt(MBAFL, flagmba);
        editor.apply();
