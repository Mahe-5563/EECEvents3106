...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.IT;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.ITFL;
...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagIt;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.it_Admin;

public class ITActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView eVEntName, eVEntDesc, sHAre, dAte, itTV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.ITEVENT);
        eVEntDesc = findViewById(R.id.ITDesc);
        sHAre = findViewById(R.id.ITBtnActShare);
        dAte = findViewById(R.id.ITdateDate);
        eVEntIMG = findViewById(R.id.ITIMG);
        inviteLog = findViewById(R.id.itINVITELog);
        itTV = findViewById(R.id.tvPeopAttendIT);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+it_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(ITActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(ITActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(ITActivity.this).load(imageURL).fit().into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        itTV.setText(count1+" People are attending this event");
                        itTV.setVisibility(View.VISIBLE);
                    }
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_IT, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(ITFL, 0);
        ...
        {
            startActivity(new Intent(ITActivity.this, DeptEventActivity.class));
            finish();
        }
    }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(it_Admin).child(tag).setValue(count);
        flagIt = 1;

        editor.putInt(ITFL, flagIt);
        editor.apply();
