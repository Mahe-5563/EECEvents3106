...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.CIVILFL;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.CSE;
...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagCivil;
...
public class CSEActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView eVEntName, eVEntDesc, sHAre, dAte, cseTV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.CSEEVENT);
        eVEntDesc = findViewById(R.id.CSEDesc);
        sHAre = findViewById(R.id.CSEBtnActShare);
        dAte = findViewById(R.id.CSEdateDate);
        eVEntIMG = findViewById(R.id.CSEIMG);
        inviteLog = findViewById(R.id.cseINVITELog);
        cseTV  = findViewById(R.id.tvPeopAttendCse);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+cse_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(CSEActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(CSEActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(CSEActivity.this).load(imageURL).fit().into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        cseTV.setText(count1+" People are attending this event");
                        cseTV.setVisibility(View.VISIBLE);
                    }
                }
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_CSE, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(CSEFL, 0);
        ...
        {
            startActivity(new Intent(CSEActivity.this, DeptEventActivity.class));
            finish();
        }
        ...
        Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                ...
                .setSocialMetaTagParameters(
                        new DynamicLink.SocialMetaTagParameters.Builder()
                                .setTitle("Computer Science And Engineering")
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(cse_Admin).child(tag).setValue(count);
        flagCse = 1;

        editor.putInt(CSEFL, flagCse);
        editor.apply();
