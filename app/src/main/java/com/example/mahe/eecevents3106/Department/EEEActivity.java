...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagEee;

public class EEEActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    String date;
    String description;
    String event;

    TextView eVEntName, eVEntDesc, sHAre, dAte, eeeTv;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.EEEEVENT);
        eVEntDesc = findViewById(R.id.EEEDesc);
        sHAre = findViewById(R.id.EEEBtnActShare);
        dAte = findViewById(R.id.EEEdateDate);
        eVEntIMG = findViewById(R.id.EEEIMG);
        inviteLog = findViewById(R.id.eeeINVITELog);
        eeeTv = findViewById(R.id.tvPeopAttendEee);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+eee_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(EEEActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(EEEActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(EEEActivity.this).load(imageURL).fit().into(eVEntIMG);

                    if(count1 >= 10)
                    {
                        eeeTv.setText(count1+" People are attending this event");
                        eeeTv.setVisibility(View.VISIBLE);
                    }
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_EEE, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(EEEFL, 0);
        ...
        {
            startActivity(new Intent(EEEActivity.this, DeptEventActivity.class));
            finish();
        }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(eee_Admin).child(tag).setValue(count);
        flagEee = 1;

        editor.putInt(EEEFL, flagEee);
        editor.apply();
