...
public class AutomobileActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView eVEntName, eVEntDesc, sHAre, dAte, auTO, auto_TV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sHAre = findViewById(R.id.AutoBtnActShare);
        dAte =  findViewById(R.id.dateDate);
        eVEntIMG = findViewById(R.id.IMG);
        auTO = findViewById(R.id.AUtoTV);
        inviteLog = findViewById(R.id.autoINVITELog);
        auto_TV = findViewById(R.id.tvPeopAttendAuto);

        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+auto_Admin);
        ...
        inviteLog.setSelection(0,false);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(AutomobileActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(AutomobileActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            if (snapshot.getValue()!= null){
                ...
                Picasso.with(AutomobileActivity.this).load(imageURL).into(eVEntIMG);
                ...
                if(count1 >= 10)
                {
                    auto_TV.setText(count1+" People are attending this event");
        ...
        Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                ...
                .setSocialMetaTagParameters(
                        new DynamicLink.SocialMetaTagParameters.Builder()
                                .setTitle("Automobile Engineering")
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_AUTO, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(AUTOFL, 0);
        ...
        {
            startActivity(new Intent(AutomobileActivity.this, DeptEventActivity.class));
            finish();
        }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(auto_Admin).child(tag).setValue(count);
        flagAuto = 1;

        editor.putInt(AUTOFL, flagAuto);
        editor.apply();
