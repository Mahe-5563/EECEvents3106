...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.ECEFL;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.EEEFL;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.EIE;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.EIEFL;
...
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagEce;
import static com.example.mahe.eecevents3106.Classes.StringDeclarations.flagEie;

public class EIEActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView eVEntName, eVEntDesc, sHAre, dAte, eieTV;
    ImageView eVEntIMG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eVEntName = findViewById(R.id.EIEEVENT);
        eVEntDesc = findViewById(R.id.EIEDesc);
        sHAre = findViewById(R.id.EIEBtnActShare);
        dAte = findViewById(R.id.EIEdateDate);
        eVEntIMG = findViewById(R.id.EIEIMG);
        inviteLog = findViewById(R.id.eieINVITELog);
        eieTV = findViewById(R.id.tvPeopAttendEie);


        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference databaseReference = firebaseDatabase.getReference("Department/"+eie_Admin);
                ...
                .addOnSuccessListener(this, new OnSuccessListener<PendingDynamicLinkData>() {
                    ...
                    public void onSuccess(PendingDynamicLinkData pendingDynamicLinkData) {
                        ...
                        if (pendingDynamicLinkData != null) {
                            ...
                            analytics = FirebaseAnalytics.getInstance(EIEActivity.this);
                            deeplink = deepLink.toString();
                            Log.v("Deep Link:", deeplink);
                            Toast.makeText(EIEActivity.this, "" + deeplink, Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                if (snapshot.getValue() != null) {
                    ...
                    Picasso.with(EIEActivity.this).load(imageURL).fit().into(eVEntIMG);
                    ...
                    if(count1 >= 10)
                    {
                        eieTV.setText(count1+" People are attending this event");
                        eieTV.setVisibility(View.VISIBLE);
                    }
        ...
        Task<ShortDynamicLink> shortLinkTask = FirebaseDynamicLinks.getInstance().createDynamicLink()
                ...
                .setSocialMetaTagParameters(
                        new DynamicLink.SocialMetaTagParameters.Builder()
                                .setTitle("Electronics and Instrumentation Engineering")
    ...
    public void onBackPressed() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(FLAG_EIE, MODE_PRIVATE);

        int flag = sharedPreferences.getInt(EIEFL, 0);
        ...
        {
            startActivity(new Intent(EIEActivity.this, DeptEventActivity.class));
            finish();
        }
    ...
    private void updateData(String tag, String count) {
        ...
        mDatabase.child(dep).child(eie_Admin).child(tag).setValue(count);
        flagEie = 1;

        editor.putInt(EIEFL, flagEie);
        editor.apply();
